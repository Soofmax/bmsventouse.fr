...
[![npm](https://img.shields.io/npm/v/@nichoth/eleventy-plugin-sitemap)](https://www.npmjs.com/package/@nichoth/eleventy-plugin-sitemap)
[![Release workflow](https://github.com/nichoth/eleventy-plugin-sitemap/workflows/Release/badge.svg)](https://github.com/nichoth/eleventy-plugin-sitemap/actions?query=workflow%3ARelease)
[![Test workflow](https://github.com/nichoth/eleventy-plugin-sitemap/workflows/Test/badge.svg)](https://github.com/nichoth/eleventy-plugin-sitemap/actions?query=workflow%3ATest)
[![codecov](https://codecov.io/gh/nichoth/eleventy-plugin-sitemap/branch/master/graph/badge.svg?token=F4X4KPQQCC)](https://codecov.io/gh/nichoth/eleventy-plugin-sitemap)
...
```sh
npm install --save @nichoth/eleventy-plugin-sitemap
```
...
```js
const sitemap = require("@nichoth/eleventy-plugin-sitemap");
...
```sh
cp node_modules/@nichoth/eleventy-plugin-sitemap/examples/default/sitemap.njk sitemap.njk
```
